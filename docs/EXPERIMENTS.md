...
首个源码锁固定官方`skyrl-v0.2.0@eddb418dd4c560db9d43ffde561f1c5e669c8990`，其`pyproject.toml`/`uv.lock` SHA256分别为`f7c5813b8fc0efd667288b43ee020cde78773d35d7e57c315f674954fc7f421b`/`6919d985d0365ef4a660fb60718355bdfb9bdecaacd13a198157333e68a6bc74`；锁定Harbor `0.4.0@a85628c803dc1713fcd26d2bb1908cde69d62317`、torch2.10.0+cu128、vLLM0.19.0、Ray2.51.1、Transformers5.3.0。2026-09-09用户改定M2训练不使用home-5090，目标顺序为Daytona GPU→Modal回退；Daytona拒绝后，当前锁选择Modal 1.5.5/L40S，仍保留Harbor 0.4任务兼容、完整SkyRL capacity canary和严格step-wise bridge三个未验项，所以`configs/m2-stack-lock.json`明确`execution_ready=false`。这些仍只是能力探测与离线配置，不是M2-A训练通过。
